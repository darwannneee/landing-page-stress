        ...
        <div className="w-full h-screen bg-center bg-cover left-0 top-0" style={{backgroundImage: `url(${Banner3.src})`}}>
            <div className="mx-4 md:mx-24 text-white pt-24">
                ...
                <div className="pt-4 md:pt-8 mx-4 md:mx-60">
                    <h1 className="text-sm md:text-[16px] 2xl:text-2xl"> <span className="md:text-[25px]">Apa itu GameFi? </span>
                     GameFi adalah gabungan dari game (permainan) dan finance (keuangan) dalam bentuk aplikasi terdesentralisasi (dApps). GameFi memungkinkan pemain memiliki item dalam game yang terverifikasi menggunakan teknologi blockchain.</h1>
                    <div className="flex pt-2">
                        <h1 className="text-xs md:text-[12px] 2xl:text-xl text-[#CF5BFF]">rybim | Posted 18/11/24</h1> 

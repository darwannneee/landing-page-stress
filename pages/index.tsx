  ...
  return (
    ...
    <main className={myFont.className}>
        <div className="w-full h-screen bg-center bg-cover md:left-0 md:top-0" style={{backgroundImage: `url(${Banner.src})`}}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                ...
                {/* Button */}
                <div className="absolute bottom-20 md:bottom-16 left-10 right-10 md:left-96 md:right-96 mx-auto grid grid-cols-3 place-items-center">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#D9D9D9] grid place-items-center">
                        <img src={GithubImage.src} alt="Github" className="w-10  md:w-14" />
                    </div>
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#D9D9D9] grid place-items-center md:mt-0">
                        <img src={DiscordImage.src} alt="Discord" className="w-12 md:w-14" />
                    </div>
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#D9D9D9] grid place-items-center md:mt-0">
                        <img src={TwitterImage.src} alt="Twitter" className="w-10 md:w-10" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="w-full h-screen bg-center bg-cover left-0 top-0" style={{backgroundImage: `url(${Banner3.src})`}}>
        <div className="mx-4 md:mx-24 text-white pt-24">
            <h1 className="text-2xl md:text-[25px] font-bold text-center">Latest News</h1>
            <div className="pt-4 md:pt-8 mx-4 md:mx-60">
                <h1 className="text-sm md:text-[16px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet iusto quod eius voluptas maxime blanditiis officia reiciendis dolorem accusamus?</h1>
                <div className="flex pt-2">
                    <h1 className="text-xs md:text-[12px] text-[#CF5BFF]">Darwan | Posted 12hrs ago</h1> 
                    <hr className="border-t-2 border-[#CF5BFF] ml-4 w-[490px] my-auto" />  
                </div>
                <div className="flex justify-center mt-2 md:mt-6">
                    <button className="w-32 md:w-[165px] h-10 md:h-[46.31px] bg-[#CF5BFF] bg-opacity-20 rounded-xl">See More</button>
                </div>
            </div>
            <div className="pt-28 md:pt-52 text-center">
                <h1 className="text-4xl md:text-[38px] mx-4 md:mx-16 leading-10">&quot;Do you want to be right or do you want to make money ?&quot;</h1>
                <h1 className="text-2xl md:text-[24px] text-[#CF5BFF] pt-3">Darwan 2023</h1>
            </div>
        </div>
    </div>
